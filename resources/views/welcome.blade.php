    ...
    <div class="container px-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="#!">{{__('menu.teachers')}}</a></li>
                <li class="nav-item"><a class="nav-link" href="#!">{{__('menu.prices')}}</a></li>
                <li class="nav-item"><a class="nav-link" href="#!">{{__('menu.materials')}}</a></li>
                <li class="nav-item"><a class="nav-link" href="#!">{{__('menu.contacts')}}</a></li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownLang">
                        <li><a class="dropdown-item" href="{{route(\Illuminate\Support\Facades\Route::currentRouteName(), ['language' => 'uk'])}}">EN</a></li>
